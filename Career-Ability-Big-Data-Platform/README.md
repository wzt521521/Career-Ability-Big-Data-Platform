...
Postman 集合位于 `docs/postman/黄健熙-认证与开放API.postman_collection.json`；发行验证集合位于 `docs/postman/release-core-api.postman_collection.json`，覆盖采集、分析、画像、推荐、报告下载和双认证开放接口。
